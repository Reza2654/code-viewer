...
Download and run `CodeViewer-v1.0.1-rc.4-Setup.exe` from the [Releases](https://github.com/Reza2654/code-viewer/releases) page.
- Installs Code Viewer to your system.
- Creates Start Menu and Desktop shortcuts.
- Automatically registers the modern Windows 11 right-click context menu.

### Option 2: Portable ZIP
Download `CodeViewer-v1.0.1-rc.4-win-x64-portable.zip`, extract anywhere, and run `CodeViewer.exe`.
