...
public partial class MainWindow : Window
{
    ...
    private async void OnAboutClick(object? sender, RoutedEventArgs e)
    {
        ...
        panel.Children.Add(new TextBlock { Text = "Version 1.0.1-rc.4.1 (Windows Native & Open Source)", FontSize = 12, Foreground = Avalonia.Media.Brushes.Gray, HorizontalAlignment = Avalonia.Layout.HorizontalAlignment.Center });
